...
import jp.dip.oyasirazu.timelogger.TimeLogger;
...
public class TimeLoggerTest extends
        ActivityInstrumentationTestCase2<TimeLogger> {
    ...
    public TimeLoggerTest() {
        super(PACKAGE_NAME, TimeLogger.class);
    }
    ...
    public void testShowActivity() {
        // アクティビティの取得
        final TimeLogger activity = getActivity();
